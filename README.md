...
<!-- FIND VERSION -->
**This README is for the `rubocop-lts` 4.x line supporting Ruby >= 2.0.**

Use this branch for released applications whose oldest supported Ruby is 2.0.
...
Compatible with MRI Ruby 2.0+ for this release line, and concordant
...
```console
bundle add rubocop-lts --version "~> 4.0"
```

If bundler is not being used to manage dependencies, install the gem by executing:

```console
gem install rubocop-lts --version "~> 4.0"
```
