...
<!-- FIND VERSION -->
**This README is for the `rubocop-lts` 16.x line enforcing Ruby 2.6 style.**

Use this branch when you want RuboCop to enforce syntax and style compatible
with Ruby 2.6. For a different linting target, choose the matching
...
This release line enforces MRI Ruby 2.6 syntax and style, with concordant
