...
<!-- FIND VERSION -->
**This README is for the `rubocop-lts` 24.x line supporting Ruby >= 3.2.**

Use this branch for released applications whose oldest supported Ruby is 3.2.
...
Compatible with MRI Ruby 3.2+ for this release line, and concordant
