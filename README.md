...
<!-- FIND VERSION -->
**This README is for the `rubocop-lts` 16.x line supporting Ruby >= 2.6.**

Use this branch for released applications whose oldest supported Ruby is 2.6.
...
Compatible with MRI Ruby 2.6+ for this release line, and concordant
...
```console
bundle add rubocop-lts --version "~> 16.0"
```

If bundler is not being used to manage dependencies, install the gem by executing:

```console
gem install rubocop-lts --version "~> 16.0"
```
