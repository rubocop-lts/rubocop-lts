...
<!-- FIND VERSION -->
**This README is for the `rubocop-lts` 18.x line supporting Ruby >= 2.7.**

Use this branch for released applications whose oldest supported Ruby is 2.7.
...
Compatible with MRI Ruby 2.7+ for this release line, and concordant
...
```console
bundle add rubocop-lts --version "~> 18.0"
```

If bundler is not being used to manage dependencies, install the gem by executing:

```console
gem install rubocop-lts --version "~> 18.0"
```
