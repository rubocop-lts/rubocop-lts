...
<!-- FIND VERSION -->
**This README is for the `rubocop-lts` 20.x line enforcing Ruby 3.0 style.**

Use this branch when you want RuboCop to enforce syntax and style compatible
with Ruby 3.0. For a different linting target, choose the matching
...
This release line enforces MRI Ruby 3.0 syntax and style, with concordant
