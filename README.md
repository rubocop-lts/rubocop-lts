...
<!-- FIND VERSION -->
**This README is for the `rubocop-lts` 10.x line supporting Ruby >= 2.3.**

Use this branch for released applications whose oldest supported Ruby is 2.3.
...
Compatible with MRI Ruby 2.3+ for this release line, and concordant
...
```console
bundle add rubocop-lts --version "~> 10.0"
```

If bundler is not being used to manage dependencies, install the gem by executing:

```console
gem install rubocop-lts --version "~> 10.0"
```
