...
<!-- FIND VERSION -->
**This README is for the `rubocop-lts` 18.x line enforcing Ruby 2.7 style.**

Use this branch when you want RuboCop to enforce syntax and style compatible
with Ruby 2.7. For a different linting target, choose the matching
...
This release line enforces MRI Ruby 2.7 syntax and style, with concordant
