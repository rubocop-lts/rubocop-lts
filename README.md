...
<!-- FIND VERSION -->
**This README is for the `rubocop-lts` 8.x line supporting Ruby >= 2.2.**

Use this branch for released applications whose oldest supported Ruby is 2.2.
...
Compatible with MRI Ruby 2.2+ for this release line, and concordant
