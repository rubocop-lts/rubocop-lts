...
<!-- FIND VERSION -->
**This README is for the `rubocop-lts` 12.x line supporting Ruby >= 2.4.**

Use this branch for released applications whose oldest supported Ruby is 2.4.
...
Compatible with MRI Ruby 2.4+ for this release line, and concordant
...
```console
bundle add rubocop-lts --version "~> 12.0"
```

If bundler is not being used to manage dependencies, install the gem by executing:

```console
gem install rubocop-lts --version "~> 12.0"
```
