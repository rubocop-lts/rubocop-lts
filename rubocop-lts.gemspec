...
Gem::Specification.new do |spec|
  ...
  # Utilities
  spec.add_dependency("rubocop-ruby2_4", "~> 3.0", ">= 3.0.1")  # >= 2.7.0
  ...
  spec.add_development_dependency("kettle-dev", "~> 3.0", ">= 3.0.33")             # ruby >= 3.2
  ...
  spec.add_development_dependency("kettle-test", "~> 2.0", ">= 2.0.21")            # ruby >= 3.2
